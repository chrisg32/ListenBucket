...
<template>
  <div class="flex flex-wrap gap-2">
    ...
    <a
      :href="rssUrl"
      target="_blank"
      class="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600 rounded-lg transition-colors"
    >
