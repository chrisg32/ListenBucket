...
<template>
  <div class="flex flex-wrap gap-2">
    ...
    <a
      :href="rssUrl"
      target="_blank"
      class="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm bg-yellow-100 dark:bg-yellow-900 text-yellow-700 dark:text-yellow-300 hover:bg-yellow-200 dark:hover:bg-yellow-800 rounded-lg transition-colors"
    >
